...
def addparamdua(request,pr,origin,destn):
    ...
    if origin == 1 and destn == 5:
        if request.method == 'POST':
            ...
            form = fm.FSForm()
            form3 = fm.DLForm()
        return render(request,'report/parameter/add_parameter2.html',{'forms':form,'forms3':form3,'dt':dt})
    if origin == 5 and destn == 1:
        ...
        if request.method == 'POST':
            ...
            form3 = fm.DLForm()
            form = fm.FSForm()
        return render(request,'report/parameter/add_parameter2a.html',{'forms':form,'forms3':form3,'dt':dt})    
    else:
